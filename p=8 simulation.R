...
#write.csv(result, file = "9.8 (20% missing rate) p=8 results with estimated weights.csv")
#write.csv(result, file = "9.8 (40% missing rate) p=8 results with estimated weights.csv")
write.csv(result, file = "9.8 (15% missing rate) p=8 results with estimated weights.csv")
